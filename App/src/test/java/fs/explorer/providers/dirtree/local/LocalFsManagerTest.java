...
public class LocalFsManagerTest {
    ...
    public void readsFile() throws URISyntaxException, IOException {
        FsPath fsPath = testFsPath("/testdirs/home/my-text.txt", false, "");
    ...
    public void readsZipFile() throws URISyntaxException, IOException {
        FsPath fsPath = testFsPath("/zips/home.zip", false, "");
        byte[] data = localFsManager.readFile(fsPath);
        assertNotNull(data);
    ...
    public void listsEntries() throws URISyntaxException, IOException {
        ...
        assertThat(paths, containsInAnyOrder(
                testFsPath("/testdirs/home/documents", true, "documents"),
                testFsPath("/testdirs/home/music", true, "music"),
                testFsPath("/testdirs/home/pics", true, "pics"),
                testFsPath("/testdirs/home/draft.txt", false, "draft.txt"),
                testFsPath("/testdirs/home/my-text.txt", false, "my-text.txt")
        ));
    }
    ...
    public void failsToListEntriesOnFile() throws URISyntaxException, IOException {
        FsPath fsPath = testFsPath("/testdirs/home/draft.txt", false, "");
    ...
    public void failsToListEntriesOnDirectoryThatIsActuallyAFile() throws URISyntaxException, IOException {
        FsPath fsPath = testFsPath("/testdirs/home/draft.txt", true, "");
        localFsManager.list(fsPath);
    }
    ...
    public void failsToListEntriesOnNonExistingPath() throws URISyntaxException, IOException {
        FsPath testDirPath = testFsPath("/testdirs", true, "");
    ...
    private FsPath testFsPath(String relativePath, boolean isDir, String lastComponent)
